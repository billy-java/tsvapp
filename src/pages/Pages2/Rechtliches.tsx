  ...
  {displayList.map((dokument) => (
    ...
    >
      <div className="text-sm text-gray-900">
        ...
        <div className="text-gray-700">{dokument.type}</div>
        <div className="text-gray-700">
          Gültig ab: {formatGermanDate(dokument.gueltigab)}
        </div>
        <div className="text-gray-700">
          Gültig bis: {formatGermanDate(dokument.gueltigbis)}
        </div>
        <div className="text-gray-700">
...
/*
 ...
 Rechtliches
• Ein Abschnitt mit den rechtlichen Informationen und Vereinsrichtlinien, wie:
• Datenschutz
• Nutzungsbedingungen
• Etc.
*/