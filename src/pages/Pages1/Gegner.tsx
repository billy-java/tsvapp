  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen my-10">
       <div className="space-y-4">
        <h3 className="text-xl font-semibold mb-4">Meine Teams</h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {vereineList.map((team) => (
            <div
              key={team.id}
              className="p-4 bg-white rounded-lg shadow-md cursor-pointer hover:bg-gray-50 transition-colors"
      ...
      {selectedTeam && (
        <div className="mb-6">
          <h3 className="text-xl font-semibold mb-4">Adversaires de {selectedTeam.name}</h3>
          ...
          <div className="overflow-x-auto bg-white rounded-lg shadow">
            <table className="min-w-full">
              ...
              <tbody className="divide-y divide-gray-200">
                {displayList
                  .filter((gegner) => gegner.gegnerIds?.includes(selectedTeam.id.toString()))
                  .map((gegner) => (
