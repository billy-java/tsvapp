...
const AdminRoute = ({ element }: { element: JSX.Element }) => {
  ...
  // Vérifier si l'utilisateur est un administrateur, sinon rediriger vers la page daccueil
  if (userState.user.rolle !== "Administrator") {
    return <Navigate to="/home" />;
  }

  // Si l'utilisateur est un administrateur, afficher le composant protégé
  return element;
};
